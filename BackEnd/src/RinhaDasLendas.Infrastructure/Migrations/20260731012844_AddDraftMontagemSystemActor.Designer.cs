...
namespace RinhaDasLendas.Infrastructure.Migrations
{
    ...
    [Migration("20260731012844_AddDraftMontagemSystemActor")]
    partial class AddDraftMontagemSystemActor
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RinhaDasLendas.Domain.Entities.DraftMontagemAcaoAdministrativa", b =>
                {
                    ...
                    b.Property<string>("ResponsavelTipo")
                        .IsRequired()
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)")
                        .HasColumnName("responsavel_tipo");
                    ...
                    b.ToTable("draft_montagem_acoes_administrativas", null, t =>
                        {
                            t.HasCheckConstraint("CK_draft_montagem_acoes_administrativas_responsavel", "(responsavel_tipo = 'User' AND responsavel_usuario_id IS NOT NULL) OR (responsavel_tipo = 'System' AND responsavel_usuario_id IS NULL)");
                        });
                });
