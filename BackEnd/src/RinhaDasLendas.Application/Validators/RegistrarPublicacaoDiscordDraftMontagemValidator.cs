...
public sealed class RegistrarPublicacaoDiscordDraftMontagemValidator : AbstractValidator<RegistrarPublicacaoDiscordDraftMontagemRequestDto>
{
    public RegistrarPublicacaoDiscordDraftMontagemValidator()
    {
        ...
        RuleFor(request => request.MessageId).NotEmpty().WithMessage(MessageCodes.FieldRequired).MaximumLength(40).WithMessage(MessageCodes.MaxLengthExceeded);
