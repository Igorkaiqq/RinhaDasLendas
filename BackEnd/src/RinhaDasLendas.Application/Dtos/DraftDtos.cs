...
public sealed record RegistrarPickDraftRequestDto(Guid JogadorId);

public sealed record CancelarDraftRequestDto(string? Motivo);
...
public sealed record DraftJogadorDto(Guid Id, string NomeExibicao);
